    ...
    React.useEffect(()=>{
      ...
      if (state===true){
        timeoutRef.current = setTimeout(()=>{
          ...
          setYear((prevalue)=>prevalue[1]===2017?[prevalue[0],prevalue[0]]:[prevalue[0],prevalue[1]+1]);
          setValue((prevalue)=>prevalue[1]===2017?[prevalue[0],prevalue[0]]:[prevalue[0],prevalue[1]+1]);
        },delay);
      }
      return ()=>{
        resetTimeout();
