        ...
        <Menu.Item key="1">
          <NavLink to="/运动项目数据">
            <span
              className="icon"
              style={{
                background: page === "运动项目数据" ? color : "",
              }}
            >
              {dashboard}
            </span>
            <span className="label">运动项目数据</span>
          </NavLink>
        </Menu.Item>
        <Menu.Item key="2">
          <NavLink to="/学生信息数据">
            <span
              className="icon"
              style={{
                background: page === "学生信息数据" ? color : "",
              }}
            >
              {tables}
            </span>
            <span className="label">学生信息数据</span>
          </NavLink>
        </Menu.Item>
        <Menu.Item key="3">
          <NavLink to="/肌肉数据展示">
            <span
              className="icon"
              style={{
                background: page === "肌肉数据展示" ? color : "",
              }}
            >
              {muscle}
            </span>
            <span className="label">肌肉数据展示</span>
          </NavLink>
        </Menu.Item>
      </Menu>
    </>
