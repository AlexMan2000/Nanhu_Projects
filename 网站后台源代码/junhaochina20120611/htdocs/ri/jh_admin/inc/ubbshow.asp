<%sub ubbshow()%>
<input onClick=Cbold() type="button" name="Bold" value="黑体">
<input onClick=Citalic() type="button" name="Italic" value="斜体"> 
<input onClick=Cunder() type="button" name="Underline" value="下划"> 
<input onClick=Ccenter() type="button" name="Center" value="居中"> 
<input onClick=Curl() type="button" name="Link" value="链接">
<input onClick=Cimage() type="button" name="image" value="图片"> 
<input onClick=Cfly() type="button" name="Fly" value="飞字"> 
<input type="button" name="iFrame" value="包含" onClick=CiFrame()>
&nbsp;&nbsp;&nbsp;<br>
字体： 
