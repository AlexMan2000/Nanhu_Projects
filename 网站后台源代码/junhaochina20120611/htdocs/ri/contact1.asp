...
<div id="Main_left">
  ...
  <ul class="left_list">
    ...
    <li id="left_list1" style="letter-spacing:-2px;"><a href="contact1.asp">メッセージフィードバック</a></li>
  </ul>
...
<div id="Main_right">
  ...
  <tr>
    <td width="176">掲示板</td>
    <td width="490" style="background:url(images/line1.jpg) no-repeat right;">&nbsp;</td>
  </tr>
</table>
<div class="Contnet">
  ...
  <table width="80%" border="0" cellpadding="0" cellspacing="0" style="margin:30px auto; color:#000; line-height:30px;">
    <tr>
    <td width="27%" align="right">会社名 ：</td>
    <td width="73%"><input type="text" name="company" size="30"/></td>
  </tr>
  <tr>
  ...
  <tr>
    <td align="right">メッセージタイトル：</td>
    <td><input type="text" name="title" size="30"/></td>
  </tr>
  <tr>
    <td align="right" valign="top">メッセージ内容：</td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td><input type="submit" name="button" id="button" value="送 信" class="Btn"/></td>
  </tr>
</table>
</form>
</div>
