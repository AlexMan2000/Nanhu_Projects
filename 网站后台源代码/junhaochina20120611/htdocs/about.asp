...
<div id="Main_left">
  ...
  <ul class="left_list">
    <li<%if request("aid")<>396 then%> id="left_list1"<%end if%>><a href="about.asp?aid=395">公司介绍</a></li>
    <li<%if request("aid")=396 then%> id="left_list1"<%end if%>><a href="about.asp?aid=396">公司理念</a></li>
  </ul>
